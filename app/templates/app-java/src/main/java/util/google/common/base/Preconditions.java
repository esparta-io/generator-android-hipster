...
package <%=appPackage%>.util.google.common.base;
...
public final class Preconditions {
   ...
   *
   * @param expression a boolean expression
   * @param errorMessage the exception message to use if the execute fails; will
   ...
   *     execute fail. The message is formed by replacing each {@code %s}
   ...
   * @throws IllegalArgumentException if {@code expression} is false
   * @throws NullPointerException if the execute fails and either {@code
